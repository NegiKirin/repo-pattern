...
const SPEC_RE = new RegExp(["Spec", "Kit"].join(" ") + "|" + ["spec", "kit"].join(""), "i");
...
export function printAudit(audit) {
  ...
  console.log(`${clean(audit.hasSpecKitReferences)} deprecated spec runtime references absent`);
  ...
  console.log(`${clean(audit.hasClaudeRulesDir)} .claude/rules absent`);
